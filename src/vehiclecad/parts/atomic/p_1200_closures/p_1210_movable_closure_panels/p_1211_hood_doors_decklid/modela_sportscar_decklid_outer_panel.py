"""Atomic part owner: PRT_ModelA_SportsCar_Decklid_Outer_Panel.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1200_closures.p_1210_movable_closure_panels.p_1211_hood_doors_decklid.modela_sportscar_decklid_outer_panel",
    source_group="body_closures",
    part_name="PRT_ModelA_SportsCar_Decklid_Outer_Panel",
    part_index=0,
