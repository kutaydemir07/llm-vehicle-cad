"""Atomic part owner: PRT_ModelA_SportsCar_Door_Outer_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1200_closures.p_1210_movable_closure_panels.p_1211_hood_doors_decklid.modela_sportscar_door_outer_r",
    source_group="body_closures",
    part_name="PRT_ModelA_SportsCar_Door_Outer_R",
    part_index=0,
