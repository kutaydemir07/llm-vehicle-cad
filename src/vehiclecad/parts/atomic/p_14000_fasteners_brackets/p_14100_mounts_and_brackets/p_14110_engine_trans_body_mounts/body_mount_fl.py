"""Atomic part owner: PRT_Body_Mount_FL.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_14000_fasteners_brackets.p_14100_mounts_and_brackets.p_14110_engine_trans_body_mounts.body_mount_fl",
    source_group="fasteners_mounts_brackets",
    part_name="PRT_Body_Mount_FL",
    part_index=0,
