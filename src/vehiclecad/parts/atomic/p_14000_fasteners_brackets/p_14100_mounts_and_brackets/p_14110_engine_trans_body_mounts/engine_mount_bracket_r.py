"""Atomic part owner: PRT_Engine_Mount_Bracket_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_14000_fasteners_brackets.p_14100_mounts_and_brackets.p_14110_engine_trans_body_mounts.engine_mount_bracket_r",
    source_group="fasteners_mounts_brackets",
    part_name="PRT_Engine_Mount_Bracket_R",
    part_index=0,
