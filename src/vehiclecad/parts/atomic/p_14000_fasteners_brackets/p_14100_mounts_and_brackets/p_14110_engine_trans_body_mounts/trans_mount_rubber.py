"""Atomic part owner: PRT_Trans_Mount_Rubber.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_14000_fasteners_brackets.p_14100_mounts_and_brackets.p_14110_engine_trans_body_mounts.trans_mount_rubber",
    source_group="fasteners_mounts_brackets",
    part_name="PRT_Trans_Mount_Rubber",
    part_index=0,
