"""Atomic part owner: PRT_Firewall_Stiffener_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_14000_fasteners_brackets.p_14100_mounts_and_brackets.p_14110_engine_trans_body_mounts.firewall_stiffener_r",
    source_group="fasteners_mounts_brackets",
    part_name="PRT_Firewall_Stiffener_R",
    part_index=0,
