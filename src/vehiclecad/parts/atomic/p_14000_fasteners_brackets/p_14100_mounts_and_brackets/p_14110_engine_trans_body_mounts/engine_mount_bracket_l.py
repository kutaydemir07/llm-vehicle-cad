"""Atomic part owner: PRT_Engine_Mount_Bracket_L.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_14000_fasteners_brackets.p_14100_mounts_and_brackets.p_14110_engine_trans_body_mounts.engine_mount_bracket_l",
    source_group="fasteners_mounts_brackets",
    part_name="PRT_Engine_Mount_Bracket_L",
    part_index=0,
