"""Atomic part owner: PRT_Rear_Wing_Pedestal_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10100_aero_body_kit.p_10140_rear_wing.rear_wing_pedestal_r",
    source_group="exterior_rear_wing",
    part_name="PRT_Rear_Wing_Pedestal_R",
    part_index=0,
