"""Atomic part owner: PRT_Box_Flares_Rear_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10100_aero_body_kit.p_10110_box_flares.box_flares_rear_r",
    source_group="exterior_flares",
    part_name="PRT_Box_Flares_Rear_R",
    part_index=0,
