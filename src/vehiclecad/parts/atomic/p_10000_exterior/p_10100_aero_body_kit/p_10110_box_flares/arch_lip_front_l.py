"""Atomic part owner: PRT_Arch_Lip_Front_L.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10100_aero_body_kit.p_10110_box_flares.arch_lip_front_l",
    source_group="exterior_flares",
    part_name="PRT_Arch_Lip_Front_L",
    part_index=0,
