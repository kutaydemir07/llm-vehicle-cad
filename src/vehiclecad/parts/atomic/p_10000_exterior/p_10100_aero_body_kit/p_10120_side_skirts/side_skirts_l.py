"""Atomic part owner: PRT_Side_Skirts_L.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10100_aero_body_kit.p_10120_side_skirts.side_skirts_l",
    source_group="exterior_side_skirts",
    part_name="PRT_Side_Skirts_L",
    part_index=0,
