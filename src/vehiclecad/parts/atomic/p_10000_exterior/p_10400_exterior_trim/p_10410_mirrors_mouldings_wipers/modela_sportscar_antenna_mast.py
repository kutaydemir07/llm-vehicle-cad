"""Atomic part owner: PRT_ModelA_SportsCar_Antenna_Mast.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10400_exterior_trim.p_10410_mirrors_mouldings_wipers.modela_sportscar_antenna_mast",
    source_group="exterior_trim",
    part_name="PRT_ModelA_SportsCar_Antenna_Mast",
    part_index=0,
