"""Atomic part owner: PRT_ModelA_SportsCar_Wiper_Arm_Blade_L.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10400_exterior_trim.p_10410_mirrors_mouldings_wipers.modela_sportscar_wiper_arm_blade_l",
    source_group="exterior_trim",
    part_name="PRT_ModelA_SportsCar_Wiper_Arm_Blade_L",
    part_index=0,
