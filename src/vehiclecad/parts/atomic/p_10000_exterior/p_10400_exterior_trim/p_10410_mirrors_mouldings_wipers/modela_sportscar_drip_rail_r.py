"""Atomic part owner: PRT_ModelA_SportsCar_Drip_Rail_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10400_exterior_trim.p_10410_mirrors_mouldings_wipers.modela_sportscar_drip_rail_r",
    source_group="exterior_trim",
    part_name="PRT_ModelA_SportsCar_Drip_Rail_R",
    part_index=0,
