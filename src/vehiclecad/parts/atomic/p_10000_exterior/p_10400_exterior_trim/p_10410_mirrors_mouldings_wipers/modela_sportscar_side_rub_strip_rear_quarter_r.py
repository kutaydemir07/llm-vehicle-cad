"""Atomic part owner: PRT_ModelA_SportsCar_Side_Rub_Strip_Rear_Quarter_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10400_exterior_trim.p_10410_mirrors_mouldings_wipers.modela_sportscar_side_rub_strip_rear_quarter_r",
    source_group="exterior_trim",
    part_name="PRT_ModelA_SportsCar_Side_Rub_Strip_Rear_Quarter_R",
    part_index=0,
