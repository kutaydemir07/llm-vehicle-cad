"""Atomic part owner: PRT_ModelA_SportsCar_Door_Mirror_Housing_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10400_exterior_trim.p_10410_mirrors_mouldings_wipers.modela_sportscar_door_mirror_housing_r",
    source_group="exterior_trim",
    part_name="PRT_ModelA_SportsCar_Door_Mirror_Housing_R",
    part_index=0,
