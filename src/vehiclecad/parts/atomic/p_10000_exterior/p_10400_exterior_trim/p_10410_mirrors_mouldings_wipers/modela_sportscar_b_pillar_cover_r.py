"""Atomic part owner: PRT_ModelA_SportsCar_B_Pillar_Cover_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10400_exterior_trim.p_10410_mirrors_mouldings_wipers.modela_sportscar_b_pillar_cover_r",
    source_group="exterior_trim",
    part_name="PRT_ModelA_SportsCar_B_Pillar_Cover_R",
    part_index=0,
