"""Atomic part owner: PRT_ModelA_SportsCar_Cowl_Vent_Slats.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10400_exterior_trim.p_10410_mirrors_mouldings_wipers.modela_sportscar_cowl_vent_slats",
    source_group="exterior_trim",
    part_name="PRT_ModelA_SportsCar_Cowl_Vent_Slats",
    part_index=0,
