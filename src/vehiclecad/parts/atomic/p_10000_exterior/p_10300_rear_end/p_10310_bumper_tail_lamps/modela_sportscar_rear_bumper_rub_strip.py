"""Atomic part owner: PRT_ModelA_SportsCar_Rear_Bumper_Rub_Strip.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10300_rear_end.p_10310_bumper_tail_lamps.modela_sportscar_rear_bumper_rub_strip",
    source_group="exterior_rearend",
    part_name="PRT_ModelA_SportsCar_Rear_Bumper_Rub_Strip",
    part_index=0,
