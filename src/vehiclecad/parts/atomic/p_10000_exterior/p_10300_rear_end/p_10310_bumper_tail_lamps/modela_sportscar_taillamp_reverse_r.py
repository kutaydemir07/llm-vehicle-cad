"""Atomic part owner: PRT_ModelA_SportsCar_Taillamp_Reverse_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10300_rear_end.p_10310_bumper_tail_lamps.modela_sportscar_taillamp_reverse_r",
    source_group="exterior_rearend",
    part_name="PRT_ModelA_SportsCar_Taillamp_Reverse_R",
    part_index=0,
