"""Atomic part owner: PRT_ModelA_SportsCar_Number_Plate_Recess.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10300_rear_end.p_10310_bumper_tail_lamps.modela_sportscar_number_plate_recess",
    source_group="exterior_rearend",
    part_name="PRT_ModelA_SportsCar_Number_Plate_Recess",
    part_index=0,
