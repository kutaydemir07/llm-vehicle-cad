"""Atomic part owner: PRT_ModelA_SportsCar_Hood_Roundel_Band.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10200_front_end.p_10210_fascia_grille_lamps.modela_sportscar_hood_roundel_band",
    source_group="exterior_frontend",
    part_name="PRT_ModelA_SportsCar_Hood_Roundel_Band",
    part_index=0,
