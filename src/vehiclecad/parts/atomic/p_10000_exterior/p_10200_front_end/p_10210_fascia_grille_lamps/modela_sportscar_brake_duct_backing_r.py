"""Atomic part owner: PRT_ModelA_SportsCar_Brake_Duct_Backing_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10200_front_end.p_10210_fascia_grille_lamps.modela_sportscar_brake_duct_backing_r",
    source_group="exterior_frontend",
    part_name="PRT_ModelA_SportsCar_Brake_Duct_Backing_R",
    part_index=0,
