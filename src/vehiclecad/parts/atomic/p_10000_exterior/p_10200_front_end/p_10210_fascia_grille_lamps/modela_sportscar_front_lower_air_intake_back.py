"""Atomic part owner: PRT_ModelA_SportsCar_Front_Lower_Air_Intake_Back.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10200_front_end.p_10210_fascia_grille_lamps.modela_sportscar_front_lower_air_intake_back",
    source_group="exterior_frontend",
    part_name="PRT_ModelA_SportsCar_Front_Lower_Air_Intake_Back",
    part_index=0,
