"""Atomic part owner: PRT_ModelA_SportsCar_Headlamp_Inner_Reflector_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10200_front_end.p_10210_fascia_grille_lamps.modela_sportscar_headlamp_inner_reflector_r",
    source_group="exterior_frontend",
    part_name="PRT_ModelA_SportsCar_Headlamp_Inner_Reflector_R",
    part_index=0,
