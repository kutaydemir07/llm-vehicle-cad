"""Atomic part owner: PRT_ModelA_SportsCar_Kidney_Grille_Frame_1.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10200_front_end.p_10210_fascia_grille_lamps.modela_sportscar_kidney_grille_frame_1",
    source_group="exterior_frontend",
    part_name="PRT_ModelA_SportsCar_Kidney_Grille_Frame_1",
    part_index=0,
