"""Atomic part owner: PRT_ModelA_SportsCar_Front_Bumper_Rub_Strip.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10200_front_end.p_10210_fascia_grille_lamps.modela_sportscar_front_bumper_rub_strip",
    source_group="exterior_frontend",
    part_name="PRT_ModelA_SportsCar_Front_Bumper_Rub_Strip",
    part_index=0,
