"""Atomic part owner: PRT_ModelA_SportsCar_Front_Lower_Air_Intake_Mesh.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10000_exterior.p_10200_front_end.p_10210_fascia_grille_lamps.modela_sportscar_front_lower_air_intake_mesh",
    source_group="exterior_frontend",
    part_name="PRT_ModelA_SportsCar_Front_Lower_Air_Intake_Mesh",
    part_index=0,
