"""Atomic part owner: PRT_Rear_Seat_Bulkhead.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1197_trunk_structure.rear_seat_bulkhead",
    source_group="body_trunk",
    part_name="PRT_Rear_Seat_Bulkhead",
    part_index=0,
