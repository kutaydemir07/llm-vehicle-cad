"""Atomic part owner: PRT_Parcel_Shelf.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1197_trunk_structure.parcel_shelf",
    source_group="body_trunk",
    part_name="PRT_Parcel_Shelf",
    part_index=0,
