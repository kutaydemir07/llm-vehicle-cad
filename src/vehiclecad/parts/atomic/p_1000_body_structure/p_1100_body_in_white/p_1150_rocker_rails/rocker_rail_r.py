"""Atomic part owner: PRT_Rocker_Rail_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1150_rocker_rails.rocker_rail_r",
    source_group="body_rockers",
    part_name="PRT_Rocker_Rail_R",
    part_index=0,
