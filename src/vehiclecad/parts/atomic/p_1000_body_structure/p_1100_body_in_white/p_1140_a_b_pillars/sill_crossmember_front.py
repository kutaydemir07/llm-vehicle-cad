"""Atomic part owner: PRT_Sill_Crossmember_Front.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1140_a_b_pillars.sill_crossmember_front",
    source_group="body_pillars",
    part_name="PRT_Sill_Crossmember_Front",
    part_index=0,
