"""Atomic part owner: PRT_B_Pillar_L.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1140_a_b_pillars.b_pillar_l",
    source_group="body_pillars",
    part_name="PRT_B_Pillar_L",
    part_index=0,
