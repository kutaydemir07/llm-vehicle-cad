"""Atomic part owner: PRT_Rear_Tail_Panel.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1198_outer_sheet_metal_panels.rear_tail_panel",
    source_group="body_outer_panels",
    part_name="PRT_Rear_Tail_Panel",
    part_index=0,
