"""Atomic part owner: PRT_Rocker_Outer_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1198_outer_sheet_metal_panels.rocker_outer_r",
    source_group="body_outer_panels",
    part_name="PRT_Rocker_Outer_R",
    part_index=0,
