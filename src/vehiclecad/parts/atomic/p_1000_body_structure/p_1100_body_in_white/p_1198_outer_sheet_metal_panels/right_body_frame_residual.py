"""Atomic part owner: PRT_Right_Body_Frame_Residual.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1198_outer_sheet_metal_panels.right_body_frame_residual",
    source_group="body_outer_panels",
    part_name="PRT_Right_Body_Frame_Residual",
    part_index=0,
