"""Atomic part owner: PRT_Rear_Quarter_L.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1198_outer_sheet_metal_panels.rear_quarter_l",
    source_group="body_outer_panels",
    part_name="PRT_Rear_Quarter_L",
    part_index=0,
