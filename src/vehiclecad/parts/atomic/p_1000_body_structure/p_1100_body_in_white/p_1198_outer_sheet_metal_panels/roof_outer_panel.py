"""Atomic part owner: PRT_Roof_Outer_Panel.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1198_outer_sheet_metal_panels.roof_outer_panel",
    source_group="body_outer_panels",
    part_name="PRT_Roof_Outer_Panel",
    part_index=0,
