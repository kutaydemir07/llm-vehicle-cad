"""Atomic part owner: PRT_Cowl_Upper_Panel.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1198_outer_sheet_metal_panels.cowl_upper_panel",
    source_group="body_outer_panels",
    part_name="PRT_Cowl_Upper_Panel",
    part_index=0,
