"""Atomic part owner: PRT_Strut_Brace_Bar_Front.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1190_strut_top_plates.strut_brace_bar_front",
    source_group="body_strut_top_plates",
    part_name="PRT_Strut_Brace_Bar_Front",
    part_index=0,
