"""Atomic part owner: PRT_C_Pillar_Modified_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1130_c_pillar_conversion.c_pillar_modified_r",
    source_group="body_c_pillars",
    part_name="PRT_C_Pillar_Modified_R",
    part_index=0,
