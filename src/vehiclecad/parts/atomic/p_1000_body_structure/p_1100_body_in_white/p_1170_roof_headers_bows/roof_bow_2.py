"""Atomic part owner: PRT_Roof_Bow_2.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1170_roof_headers_bows.roof_bow_2",
    source_group="body_roof_structure",
    part_name="PRT_Roof_Bow_2",
    part_index=0,
