"""Atomic part owner: PRT_Rear_Roof_Header.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1170_roof_headers_bows.rear_roof_header",
    source_group="body_roof_structure",
    part_name="PRT_Rear_Roof_Header",
    part_index=0,
