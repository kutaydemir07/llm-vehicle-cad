"""Atomic part owner: PRT_Apron_Rail_L.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1196_engine_bay_panels.apron_rail_l",
    source_group="body_engine_bay",
    part_name="PRT_Apron_Rail_L",
    part_index=0,
