"""Atomic part owner: PRT_Radiator_Support.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1196_engine_bay_panels.radiator_support",
    source_group="body_engine_bay",
    part_name="PRT_Radiator_Support",
    part_index=0,
