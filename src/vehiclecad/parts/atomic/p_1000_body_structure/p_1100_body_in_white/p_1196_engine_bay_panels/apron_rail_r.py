"""Atomic part owner: PRT_Apron_Rail_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1196_engine_bay_panels.apron_rail_r",
    source_group="body_engine_bay",
    part_name="PRT_Apron_Rail_R",
    part_index=0,
