"""Atomic part owner: PRT_Rear_Wheel_Tub_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1195_wheel_tubs.rear_wheel_tub_r",
    source_group="body_wheel_tubs",
    part_name="PRT_Rear_Wheel_Tub_R",
    part_index=0,
