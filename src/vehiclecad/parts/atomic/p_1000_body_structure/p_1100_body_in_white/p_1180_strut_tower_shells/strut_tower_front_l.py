"""Atomic part owner: PRT_Strut_Tower_Front_L.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_1000_body_structure.p_1100_body_in_white.p_1180_strut_tower_shells.strut_tower_front_l",
    source_group="body_strut_towers_shell",
    part_name="PRT_Strut_Tower_Front_L",
    part_index=0,
