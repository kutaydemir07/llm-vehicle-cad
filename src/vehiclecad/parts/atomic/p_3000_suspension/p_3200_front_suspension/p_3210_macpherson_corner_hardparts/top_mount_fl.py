"""Atomic part owner: PRT_Top_Mount_FL.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_3000_suspension.p_3200_front_suspension.p_3210_macpherson_corner_hardparts.top_mount_fl",
    source_group="suspension_front_macpherson",
    part_name="PRT_Top_Mount_FL",
    part_index=0,
