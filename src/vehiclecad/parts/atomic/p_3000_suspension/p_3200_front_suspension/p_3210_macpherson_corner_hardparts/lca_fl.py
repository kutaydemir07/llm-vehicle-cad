...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_3000_suspension.p_3200_front_suspension.p_3210_macpherson_corner_hardparts.lca_fl",
    source_group="suspension_front_macpherson",
    part_name="PRT_LCA_FL",
    part_index=0,
