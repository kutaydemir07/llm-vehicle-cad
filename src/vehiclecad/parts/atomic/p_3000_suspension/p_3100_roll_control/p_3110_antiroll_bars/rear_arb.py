"""Atomic part owner: PRT_Rear_ARB.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_3000_suspension.p_3100_roll_control.p_3110_antiroll_bars.rear_arb",
    source_group="suspension_antiroll_bars",
    part_name="PRT_Rear_ARB",
    part_index=0,
