"""Atomic part owner: PRT_Trailing_Arm_RR.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_3000_suspension.p_3300_rear_suspension.p_3310_semi_trailing_arm_corner_hardparts.trailing_arm_rr",
    source_group="suspension_rear_semitrailing",
    part_name="PRT_Trailing_Arm_RR",
    part_index=0,
