"""Atomic part owner: PRT_Rear_Spring_Upper_Perch_RR.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_3000_suspension.p_3300_rear_suspension.p_3310_semi_trailing_arm_corner_hardparts.rear_spring_upper_perch_rr",
    source_group="suspension_rear_semitrailing",
    part_name="PRT_Rear_Spring_Upper_Perch_RR",
    part_index=0,
