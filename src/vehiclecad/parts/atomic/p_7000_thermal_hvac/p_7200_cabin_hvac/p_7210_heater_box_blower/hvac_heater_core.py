"""Atomic part owner: PRT_HVAC_Heater_Core.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_7000_thermal_hvac.p_7200_cabin_hvac.p_7210_heater_box_blower.hvac_heater_core",
    source_group="thermal_hvac",
    part_name="PRT_HVAC_Heater_Core",
    part_index=0,
