"""Atomic part owner: PRT_HVAC_Control_Cable_Set.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_7000_thermal_hvac.p_7200_cabin_hvac.p_7210_heater_box_blower.hvac_control_cable_set",
    source_group="thermal_hvac",
    part_name="PRT_HVAC_Control_Cable_Set",
    part_index=0,
