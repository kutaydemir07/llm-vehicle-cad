"""Atomic part owner: PRT_HVAC_Centre_Duct.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_7000_thermal_hvac.p_7200_cabin_hvac.p_7210_heater_box_blower.hvac_centre_duct",
    source_group="thermal_hvac",
    part_name="PRT_HVAC_Centre_Duct",
    part_index=0,
