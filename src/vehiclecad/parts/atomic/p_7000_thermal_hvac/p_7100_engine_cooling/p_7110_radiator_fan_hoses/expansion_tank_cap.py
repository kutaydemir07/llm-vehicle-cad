"""Atomic part owner: PRT_Expansion_Tank_Cap.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_7000_thermal_hvac.p_7100_engine_cooling.p_7110_radiator_fan_hoses.expansion_tank_cap",
    source_group="thermal_cooling",
    part_name="PRT_Expansion_Tank_Cap",
    part_index=0,
