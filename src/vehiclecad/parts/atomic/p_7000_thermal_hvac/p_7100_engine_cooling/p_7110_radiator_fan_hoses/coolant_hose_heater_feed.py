"""Atomic part owner: PRT_Coolant_Hose_Heater_Feed.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_7000_thermal_hvac.p_7100_engine_cooling.p_7110_radiator_fan_hoses.coolant_hose_heater_feed",
    source_group="thermal_cooling",
    part_name="PRT_Coolant_Hose_Heater_Feed",
    part_index=0,
