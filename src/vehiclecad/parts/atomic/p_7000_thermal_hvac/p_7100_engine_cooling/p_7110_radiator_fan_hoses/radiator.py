"""Atomic part owner: PRT_Radiator.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_7000_thermal_hvac.p_7100_engine_cooling.p_7110_radiator_fan_hoses.radiator",
    source_group="thermal_cooling",
    part_name="PRT_Radiator",
    part_index=0,
