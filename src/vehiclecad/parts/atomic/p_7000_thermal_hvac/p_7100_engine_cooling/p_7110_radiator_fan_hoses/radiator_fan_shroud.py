"""Atomic part owner: PRT_Radiator_Fan_Shroud.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_7000_thermal_hvac.p_7100_engine_cooling.p_7110_radiator_fan_hoses.radiator_fan_shroud",
    source_group="thermal_cooling",
    part_name="PRT_Radiator_Fan_Shroud",
    part_index=0,
