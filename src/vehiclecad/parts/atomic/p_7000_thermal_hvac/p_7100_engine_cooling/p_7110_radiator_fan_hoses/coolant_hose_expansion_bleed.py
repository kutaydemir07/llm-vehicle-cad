"""Atomic part owner: PRT_Coolant_Hose_Expansion_Bleed.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_7000_thermal_hvac.p_7100_engine_cooling.p_7110_radiator_fan_hoses.coolant_hose_expansion_bleed",
    source_group="thermal_cooling",
    part_name="PRT_Coolant_Hose_Expansion_Bleed",
    part_index=0,
