"""Atomic part owner: PRT_Expansion_Tank.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_7000_thermal_hvac.p_7100_engine_cooling.p_7110_radiator_fan_hoses.expansion_tank",
    source_group="thermal_cooling",
    part_name="PRT_Expansion_Tank",
    part_index=0,
