"""Atomic part owner: PRT_Ujoint_Rear.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6230_propshaft.p_6231_two_piece_propshaft.ujoint_rear",
    source_group="driveline_propshaft",
    part_name="PRT_Ujoint_Rear",
    part_index=0,
