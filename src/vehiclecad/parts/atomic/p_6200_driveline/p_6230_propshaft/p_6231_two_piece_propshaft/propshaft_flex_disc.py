"""Atomic part owner: PRT_Propshaft_Flex_Disc.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6230_propshaft.p_6231_two_piece_propshaft.propshaft_flex_disc",
    source_group="driveline_propshaft",
    part_name="PRT_Propshaft_Flex_Disc",
    part_index=0,
