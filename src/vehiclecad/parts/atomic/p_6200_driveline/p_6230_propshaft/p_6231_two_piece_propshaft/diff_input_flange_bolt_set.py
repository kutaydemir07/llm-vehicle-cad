"""Atomic part owner: PRT_Diff_Input_Flange_Bolt_Set.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6230_propshaft.p_6231_two_piece_propshaft.diff_input_flange_bolt_set",
    source_group="driveline_propshaft",
    part_name="PRT_Diff_Input_Flange_Bolt_Set",
    part_index=0,
