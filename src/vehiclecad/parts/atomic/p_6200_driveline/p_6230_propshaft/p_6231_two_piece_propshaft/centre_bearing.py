"""Atomic part owner: PRT_Centre_Bearing.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6230_propshaft.p_6231_two_piece_propshaft.centre_bearing",
    source_group="driveline_propshaft",
    part_name="PRT_Centre_Bearing",
    part_index=0,
