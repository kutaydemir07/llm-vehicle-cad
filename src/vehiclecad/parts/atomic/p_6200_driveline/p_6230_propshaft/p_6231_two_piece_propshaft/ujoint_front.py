"""Atomic part owner: PRT_Ujoint_Front.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6230_propshaft.p_6231_two_piece_propshaft.ujoint_front",
    source_group="driveline_propshaft",
    part_name="PRT_Ujoint_Front",
    part_index=0,
