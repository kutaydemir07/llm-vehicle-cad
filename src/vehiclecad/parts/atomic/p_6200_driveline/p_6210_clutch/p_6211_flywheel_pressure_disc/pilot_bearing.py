"""Atomic part owner: PRT_Pilot_Bearing.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6210_clutch.p_6211_flywheel_pressure_disc.pilot_bearing",
    source_group="driveline_clutch",
    part_name="PRT_Pilot_Bearing",
    part_index=0,
