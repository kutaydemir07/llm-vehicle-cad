"""Atomic part owner: PRT_Pressure_Plate.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6210_clutch.p_6211_flywheel_pressure_disc.pressure_plate",
    source_group="driveline_clutch",
    part_name="PRT_Pressure_Plate",
    part_index=0,
