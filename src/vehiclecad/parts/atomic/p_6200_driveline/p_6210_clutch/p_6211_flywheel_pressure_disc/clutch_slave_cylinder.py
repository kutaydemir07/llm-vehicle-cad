"""Atomic part owner: PRT_Clutch_Slave_Cylinder.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6210_clutch.p_6211_flywheel_pressure_disc.clutch_slave_cylinder",
    source_group="driveline_clutch",
    part_name="PRT_Clutch_Slave_Cylinder",
    part_index=0,
