"""Atomic part owner: PRT_Flywheel.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6210_clutch.p_6211_flywheel_pressure_disc.flywheel",
    source_group="driveline_clutch",
    part_name="PRT_Flywheel",
    part_index=0,
