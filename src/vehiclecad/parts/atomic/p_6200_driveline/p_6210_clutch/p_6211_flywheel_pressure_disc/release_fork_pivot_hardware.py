"""Atomic part owner: PRT_Release_Fork_Pivot_Hardware.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6210_clutch.p_6211_flywheel_pressure_disc.release_fork_pivot_hardware",
    source_group="driveline_clutch",
    part_name="PRT_Release_Fork_Pivot_Hardware",
    part_index=0,
