"""Atomic part owner: PRT_Rear_LSD_Output_Flange_L.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6220_final_drive.p_6221_rear_differential.rear_lsd_output_flange_l",
    source_group="driveline_differential",
    part_name="PRT_Rear_LSD_Output_Flange_L",
    part_index=0,
