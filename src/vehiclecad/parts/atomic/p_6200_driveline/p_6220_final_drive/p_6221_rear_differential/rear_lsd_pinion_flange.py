"""Atomic part owner: PRT_Rear_LSD_Pinion_Flange.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6220_final_drive.p_6221_rear_differential.rear_lsd_pinion_flange",
    source_group="driveline_differential",
    part_name="PRT_Rear_LSD_Pinion_Flange",
    part_index=0,
