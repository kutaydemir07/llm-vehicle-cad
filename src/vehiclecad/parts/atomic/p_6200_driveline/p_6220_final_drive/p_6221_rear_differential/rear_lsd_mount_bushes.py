"""Atomic part owner: PRT_Rear_LSD_Mount_Bushes.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6220_final_drive.p_6221_rear_differential.rear_lsd_mount_bushes",
    source_group="driveline_differential",
    part_name="PRT_Rear_LSD_Mount_Bushes",
    part_index=0,
