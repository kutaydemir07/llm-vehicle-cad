"""Atomic part owner: PRT_CV_Axle_Nut_RL.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6240_half_shafts.p_6241_rear_cv_shafts.cv_axle_nut_rl",
    source_group="driveline_half_shafts",
    part_name="PRT_CV_Axle_Nut_RL",
    part_index=0,
