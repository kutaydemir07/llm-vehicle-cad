"""Atomic part owner: PRT_CV_Boot_Inner_Clamp_Small_RL.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6240_half_shafts.p_6241_rear_cv_shafts.cv_boot_inner_clamp_small_rl",
    source_group="driveline_half_shafts",
    part_name="PRT_CV_Boot_Inner_Clamp_Small_RL",
    part_index=0,
