"""Atomic part owner: PRT_Half_Shaft_RR.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6200_driveline.p_6240_half_shafts.p_6241_rear_cv_shafts.half_shaft_rr",
    source_group="driveline_half_shafts",
    part_name="PRT_Half_Shaft_RR",
    part_index=0,
