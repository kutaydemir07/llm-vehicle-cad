"""Atomic part owner: PRT_ITB_Runner_4.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6300_air_and_exhaust.p_6320_intake_path.itb_runner_4",
    source_group="powertrain_intake",
    part_name="PRT_ITB_Runner_4",
    part_index=0,
