"""Atomic part owner: PRT_Fuel_Rail.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6300_air_and_exhaust.p_6320_intake_path.fuel_rail",
    source_group="powertrain_intake",
    part_name="PRT_Fuel_Rail",
    part_index=0,
