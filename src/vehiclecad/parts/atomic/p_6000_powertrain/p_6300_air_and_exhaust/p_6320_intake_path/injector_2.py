"""Atomic part owner: PRT_Injector_2.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6300_air_and_exhaust.p_6320_intake_path.injector_2",
    source_group="powertrain_intake",
    part_name="PRT_Injector_2",
    part_index=0,
