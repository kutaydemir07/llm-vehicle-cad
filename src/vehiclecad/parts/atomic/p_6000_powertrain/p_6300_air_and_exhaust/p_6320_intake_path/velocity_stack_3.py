"""Atomic part owner: PRT_Velocity_Stack_3.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6300_air_and_exhaust.p_6320_intake_path.velocity_stack_3",
    source_group="powertrain_intake",
    part_name="PRT_Velocity_Stack_3",
    part_index=0,
