"""Atomic part owner: PRT_Throttle_Body_4.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6300_air_and_exhaust.p_6320_intake_path.throttle_body_4",
    source_group="powertrain_intake",
    part_name="PRT_Throttle_Body_4",
    part_index=0,
