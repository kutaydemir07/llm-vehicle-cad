"""Atomic part owner: PRT_Exhaust_Primary_3.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6300_air_and_exhaust.p_6310_exhaust_path.exhaust_primary_3",
    source_group="powertrain_exhaust",
    part_name="PRT_Exhaust_Primary_3",
    part_index=0,
