"""Atomic part owner: PRT_ManualGearbox_265_Gear_Pair_5.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6500_transmission.p_6510_gearbox.manualgearbox_265_gear_pair_5",
    source_group="powertrain_transmission",
    part_name="PRT_ManualGearbox_265_Gear_Pair_5",
    part_index=0,
