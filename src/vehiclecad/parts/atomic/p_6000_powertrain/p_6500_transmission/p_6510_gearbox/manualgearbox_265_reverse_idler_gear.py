"""Atomic part owner: PRT_ManualGearbox_265_Reverse_Idler_Gear.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6500_transmission.p_6510_gearbox.manualgearbox_265_reverse_idler_gear",
    source_group="powertrain_transmission",
    part_name="PRT_ManualGearbox_265_Reverse_Idler_Gear",
    part_index=0,
