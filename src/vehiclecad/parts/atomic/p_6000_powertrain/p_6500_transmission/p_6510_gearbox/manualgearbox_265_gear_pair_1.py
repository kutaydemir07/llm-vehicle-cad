"""Atomic part owner: PRT_ManualGearbox_265_Gear_Pair_1.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6500_transmission.p_6510_gearbox.manualgearbox_265_gear_pair_1",
    source_group="powertrain_transmission",
    part_name="PRT_ManualGearbox_265_Gear_Pair_1",
    part_index=0,
