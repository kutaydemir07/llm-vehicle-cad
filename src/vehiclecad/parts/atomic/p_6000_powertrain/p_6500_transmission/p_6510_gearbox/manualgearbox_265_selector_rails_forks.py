"""Atomic part owner: PRT_ManualGearbox_265_Selector_Rails_Forks.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6500_transmission.p_6510_gearbox.manualgearbox_265_selector_rails_forks",
    source_group="powertrain_transmission",
    part_name="PRT_ManualGearbox_265_Selector_Rails_Forks",
    part_index=0,
