"""Atomic part owner: PRT_ManualGearbox_265_Output_Shaft.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6500_transmission.p_6510_gearbox.manualgearbox_265_output_shaft",
    source_group="powertrain_transmission",
    part_name="PRT_ManualGearbox_265_Output_Shaft",
    part_index=0,
