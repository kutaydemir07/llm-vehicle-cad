"""Atomic part owner: PRT_Fuel_Pump.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6400_fuel_storage_and_delivery.p_6410_tank_pump_filter_lines.fuel_pump",
    source_group="powertrain_fuel_system",
    part_name="PRT_Fuel_Pump",
    part_index=0,
