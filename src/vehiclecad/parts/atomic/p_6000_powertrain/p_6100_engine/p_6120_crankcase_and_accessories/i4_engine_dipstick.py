"""Atomic part owner: PRT_I4_Engine_Dipstick.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6100_engine.p_6120_crankcase_and_accessories.i4_engine_dipstick",
    source_group="powertrain_engine_block",
    part_name="PRT_I4_Engine_Dipstick",
    part_index=0,
