"""Atomic part owner: PRT_I4_Engine_Oil_Filter.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6100_engine.p_6120_crankcase_and_accessories.i4_engine_oil_filter",
    source_group="powertrain_engine_block",
    part_name="PRT_I4_Engine_Oil_Filter",
    part_index=0,
