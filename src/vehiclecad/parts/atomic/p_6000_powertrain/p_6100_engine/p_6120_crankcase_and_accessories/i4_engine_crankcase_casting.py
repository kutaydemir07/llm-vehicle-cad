"""Atomic part owner: PRT_I4_Engine_Crankcase_Casting.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6100_engine.p_6120_crankcase_and_accessories.i4_engine_crankcase_casting",
    source_group="powertrain_engine_block",
    part_name="PRT_I4_Engine_Crankcase_Casting",
    part_index=0,
