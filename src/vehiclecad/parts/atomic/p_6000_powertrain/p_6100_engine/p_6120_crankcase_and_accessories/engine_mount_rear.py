"""Atomic part owner: PRT_Engine_Mount_Rear.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6100_engine.p_6120_crankcase_and_accessories.engine_mount_rear",
    source_group="powertrain_engine_block",
    part_name="PRT_Engine_Mount_Rear",
    part_index=0,
