"""Atomic part owner: PRT_I4_Engine_Valve_Cover_Detailed.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6100_engine.p_6110_cylinder_head_and_cover.i4_engine_valve_cover_detailed",
    source_group="powertrain_cylinder_head",
    part_name="PRT_I4_Engine_Valve_Cover_Detailed",
    part_index=0,
