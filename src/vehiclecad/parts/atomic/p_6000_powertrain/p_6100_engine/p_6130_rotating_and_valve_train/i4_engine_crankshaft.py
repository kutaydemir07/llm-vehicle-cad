"""Atomic part owner: PRT_I4_Engine_Crankshaft.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_6000_powertrain.p_6100_engine.p_6130_rotating_and_valve_train.i4_engine_crankshaft",
    source_group="powertrain_engine_internals",
    part_name="PRT_I4_Engine_Crankshaft",
    part_index=0,
