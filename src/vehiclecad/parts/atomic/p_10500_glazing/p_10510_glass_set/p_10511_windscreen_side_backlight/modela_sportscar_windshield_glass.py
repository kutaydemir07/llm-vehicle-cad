"""Atomic part owner: PRT_ModelA_SportsCar_Windshield_Glass.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10500_glazing.p_10510_glass_set.p_10511_windscreen_side_backlight.modela_sportscar_windshield_glass",
    source_group="exterior_glazing",
    part_name="PRT_ModelA_SportsCar_Windshield_Glass",
    part_index=0,
