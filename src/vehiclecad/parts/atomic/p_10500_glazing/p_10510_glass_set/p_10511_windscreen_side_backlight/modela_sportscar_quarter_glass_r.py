"""Atomic part owner: PRT_ModelA_SportsCar_Quarter_Glass_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_10500_glazing.p_10510_glass_set.p_10511_windscreen_side_backlight.modela_sportscar_quarter_glass_r",
    source_group="exterior_glazing",
    part_name="PRT_ModelA_SportsCar_Quarter_Glass_R",
    part_index=0,
