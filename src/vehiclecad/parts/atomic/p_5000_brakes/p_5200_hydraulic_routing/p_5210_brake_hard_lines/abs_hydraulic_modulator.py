"""Atomic part owner: PRT_ABS_Hydraulic_Modulator.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_5000_brakes.p_5200_hydraulic_routing.p_5210_brake_hard_lines.abs_hydraulic_modulator",
    source_group="brakes_hard_lines",
    part_name="PRT_ABS_Hydraulic_Modulator",
    part_index=0,
