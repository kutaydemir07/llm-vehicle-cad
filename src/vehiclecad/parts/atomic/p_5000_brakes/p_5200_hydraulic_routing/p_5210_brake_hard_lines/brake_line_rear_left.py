"""Atomic part owner: PRT_Brake_Line_Rear_Left.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_5000_brakes.p_5200_hydraulic_routing.p_5210_brake_hard_lines.brake_line_rear_left",
    source_group="brakes_hard_lines",
    part_name="PRT_Brake_Line_Rear_Left",
    part_index=0,
