"""Atomic part owner: PRT_Handbrake_Cable_Left.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_5000_brakes.p_5300_parking_brake.p_5310_lever_and_cables.handbrake_cable_left",
    source_group="brakes_handbrake",
    part_name="PRT_Handbrake_Cable_Left",
    part_index=0,
