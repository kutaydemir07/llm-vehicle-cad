"""Atomic part owner: PRT_Handbrake_Lever.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_5000_brakes.p_5300_parking_brake.p_5310_lever_and_cables.handbrake_lever",
    source_group="brakes_handbrake",
    part_name="PRT_Handbrake_Lever",
    part_index=0,
