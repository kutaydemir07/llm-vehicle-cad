"""Atomic part owner: PRT_Brake_Master_Cylinder.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_5000_brakes.p_5100_hydraulic_actuation.p_5110_booster_master_cylinder.brake_master_cylinder",
    source_group="brakes_booster_master",
    part_name="PRT_Brake_Master_Cylinder",
    part_index=0,
