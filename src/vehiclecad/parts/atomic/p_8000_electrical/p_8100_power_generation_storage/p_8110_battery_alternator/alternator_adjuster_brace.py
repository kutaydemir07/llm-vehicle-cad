"""Atomic part owner: PRT_Alternator_Adjuster_Brace.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8100_power_generation_storage.p_8110_battery_alternator.alternator_adjuster_brace",
    source_group="electrical_battery_alternator",
    part_name="PRT_Alternator_Adjuster_Brace",
    part_index=0,
