"""Atomic part owner: PRT_Wiring_Battery_Ground_Strap.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8100_power_generation_storage.p_8110_battery_alternator.wiring_battery_ground_strap",
    source_group="electrical_battery_alternator",
    part_name="PRT_Wiring_Battery_Ground_Strap",
    part_index=0,
