"""Atomic part owner: PRT_Alternator_Output_Stud.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8100_power_generation_storage.p_8110_battery_alternator.alternator_output_stud",
    source_group="electrical_battery_alternator",
    part_name="PRT_Alternator_Output_Stud",
    part_index=0,
