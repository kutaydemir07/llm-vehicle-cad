"""Atomic part owner: PRT_Battery_Terminal_Negative.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8100_power_generation_storage.p_8110_battery_alternator.battery_terminal_negative",
    source_group="electrical_battery_alternator",
    part_name="PRT_Battery_Terminal_Negative",
    part_index=0,
