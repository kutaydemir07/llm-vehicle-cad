"""Atomic part owner: PRT_Fusible_Link_Block.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8200_control_and_protection.p_8210_ecu_fusebox.fusible_link_block",
    source_group="electrical_ecu_fusebox",
    part_name="PRT_Fusible_Link_Block",
    part_index=0,
