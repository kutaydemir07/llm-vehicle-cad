"""Atomic part owner: PRT_Fuse_Relay_Box_Cover.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8200_control_and_protection.p_8210_ecu_fusebox.fuse_relay_box_cover",
    source_group="electrical_ecu_fusebox",
    part_name="PRT_Fuse_Relay_Box_Cover",
    part_index=0,
