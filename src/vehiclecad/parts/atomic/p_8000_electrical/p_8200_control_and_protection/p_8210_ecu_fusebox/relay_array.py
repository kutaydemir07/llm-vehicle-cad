"""Atomic part owner: PRT_Relay_Array.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8200_control_and_protection.p_8210_ecu_fusebox.relay_array",
    source_group="electrical_ecu_fusebox",
    part_name="PRT_Relay_Array",
    part_index=0,
