"""Atomic part owner: PRT_ECU_Motronic.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8200_control_and_protection.p_8210_ecu_fusebox.ecu_motronic",
    source_group="electrical_ecu_fusebox",
    part_name="PRT_ECU_Motronic",
    part_index=0,
