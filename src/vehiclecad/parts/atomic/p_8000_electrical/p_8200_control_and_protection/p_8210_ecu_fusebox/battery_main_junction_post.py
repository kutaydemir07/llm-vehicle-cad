"""Atomic part owner: PRT_Battery_Main_Junction_Post.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8200_control_and_protection.p_8210_ecu_fusebox.battery_main_junction_post",
    source_group="electrical_ecu_fusebox",
    part_name="PRT_Battery_Main_Junction_Post",
    part_index=0,
