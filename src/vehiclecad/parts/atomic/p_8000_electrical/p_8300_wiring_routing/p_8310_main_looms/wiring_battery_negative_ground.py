"""Atomic part owner: PRT_Wiring_Battery_Negative_Ground.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8300_wiring_routing.p_8310_main_looms.wiring_battery_negative_ground",
    source_group="electrical_wiring",
    part_name="PRT_Wiring_Battery_Negative_Ground",
    part_index=0,
