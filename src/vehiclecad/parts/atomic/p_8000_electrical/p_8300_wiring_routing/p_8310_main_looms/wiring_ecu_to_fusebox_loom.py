"""Atomic part owner: PRT_Wiring_ECU_To_Fusebox_Loom.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8300_wiring_routing.p_8310_main_looms.wiring_ecu_to_fusebox_loom",
    source_group="electrical_wiring",
    part_name="PRT_Wiring_ECU_To_Fusebox_Loom",
    part_index=0,
