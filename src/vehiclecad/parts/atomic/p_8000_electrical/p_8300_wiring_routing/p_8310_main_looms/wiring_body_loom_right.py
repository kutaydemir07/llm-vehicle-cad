"""Atomic part owner: PRT_Wiring_Body_Loom_Right.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8300_wiring_routing.p_8310_main_looms.wiring_body_loom_right",
    source_group="electrical_wiring",
    part_name="PRT_Wiring_Body_Loom_Right",
    part_index=0,
