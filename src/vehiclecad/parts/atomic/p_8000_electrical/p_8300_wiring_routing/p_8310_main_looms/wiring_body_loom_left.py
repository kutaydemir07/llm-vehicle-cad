"""Atomic part owner: PRT_Wiring_Body_Loom_Left.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8300_wiring_routing.p_8310_main_looms.wiring_body_loom_left",
    source_group="electrical_wiring",
    part_name="PRT_Wiring_Body_Loom_Left",
    part_index=0,
