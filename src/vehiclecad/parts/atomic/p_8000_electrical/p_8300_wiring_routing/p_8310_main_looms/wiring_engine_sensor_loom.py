"""Atomic part owner: PRT_Wiring_Engine_Sensor_Loom.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8300_wiring_routing.p_8310_main_looms.wiring_engine_sensor_loom",
    source_group="electrical_wiring",
    part_name="PRT_Wiring_Engine_Sensor_Loom",
    part_index=0,
