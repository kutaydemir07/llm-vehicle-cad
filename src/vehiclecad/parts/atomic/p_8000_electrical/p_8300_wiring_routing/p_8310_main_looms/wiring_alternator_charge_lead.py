"""Atomic part owner: PRT_Wiring_Alternator_Charge_Lead.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8300_wiring_routing.p_8310_main_looms.wiring_alternator_charge_lead",
    source_group="electrical_wiring",
    part_name="PRT_Wiring_Alternator_Charge_Lead",
    part_index=0,
