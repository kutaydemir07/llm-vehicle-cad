"""Atomic part owner: PRT_Wiring_Front_Lighting_Loom.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8300_wiring_routing.p_8310_main_looms.wiring_front_lighting_loom",
    source_group="electrical_wiring",
    part_name="PRT_Wiring_Front_Lighting_Loom",
    part_index=0,
