"""Atomic part owner: PRT_Wiring_Firewall_Grommet.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8300_wiring_routing.p_8310_main_looms.wiring_firewall_grommet",
    source_group="electrical_wiring",
    part_name="PRT_Wiring_Firewall_Grommet",
    part_index=0,
