"""Atomic part owner: PRT_Wiring_Right_Side_Clip_Set.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_8000_electrical.p_8300_wiring_routing.p_8310_main_looms.wiring_right_side_clip_set",
    source_group="electrical_wiring",
    part_name="PRT_Wiring_Right_Side_Clip_Set",
    part_index=0,
