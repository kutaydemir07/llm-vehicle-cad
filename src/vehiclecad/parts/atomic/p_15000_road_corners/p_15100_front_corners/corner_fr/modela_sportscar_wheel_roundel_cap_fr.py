"""Atomic part owner: PRT_ModelA_SportsCar_Wheel_Roundel_Cap_FR.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_15000_road_corners.p_15100_front_corners.corner_fr.modela_sportscar_wheel_roundel_cap_fr",
    source_group="corner_fr",
    part_name="PRT_ModelA_SportsCar_Wheel_Roundel_Cap_FR",
    part_index=0,
