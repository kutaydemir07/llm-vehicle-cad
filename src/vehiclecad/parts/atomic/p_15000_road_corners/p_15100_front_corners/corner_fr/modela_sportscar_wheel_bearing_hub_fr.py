"""Atomic part owner: PRT_ModelA_SportsCar_Wheel_Bearing_Hub_FR.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_15000_road_corners.p_15100_front_corners.corner_fr.modela_sportscar_wheel_bearing_hub_fr",
    source_group="corner_fr",
    part_name="PRT_ModelA_SportsCar_Wheel_Bearing_Hub_FR",
    part_index=0,
