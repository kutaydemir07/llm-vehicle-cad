"""Atomic part owner: PRT_ModelA_SportsCar_Mesh_Rim_Lip_FL.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_15000_road_corners.p_15100_front_corners.corner_fl.modela_sportscar_mesh_rim_lip_fl",
    source_group="corner_fl",
    part_name="PRT_ModelA_SportsCar_Mesh_Rim_Lip_FL",
    part_index=0,
