"""Atomic part owner: PRT_ModelA_SportsCar_Brake_Caliper_RR.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_15000_road_corners.p_15200_rear_corners.corner_rr.modela_sportscar_brake_caliper_rr",
    source_group="corner_rr",
    part_name="PRT_ModelA_SportsCar_Brake_Caliper_RR",
    part_index=0,
