"""Atomic part owner: PRT_ModelA_SportsCar_Wheel_Roundel_Cap_RR.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_15000_road_corners.p_15200_rear_corners.corner_rr.modela_sportscar_wheel_roundel_cap_rr",
    source_group="corner_rr",
    part_name="PRT_ModelA_SportsCar_Wheel_Roundel_Cap_RR",
    part_index=0,
