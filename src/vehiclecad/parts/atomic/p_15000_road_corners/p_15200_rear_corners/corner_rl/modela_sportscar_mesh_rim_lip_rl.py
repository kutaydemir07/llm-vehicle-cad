"""Atomic part owner: PRT_ModelA_SportsCar_Mesh_Rim_Lip_RL.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_15000_road_corners.p_15200_rear_corners.corner_rl.modela_sportscar_mesh_rim_lip_rl",
    source_group="corner_rl",
    part_name="PRT_ModelA_SportsCar_Mesh_Rim_Lip_RL",
    part_index=0,
