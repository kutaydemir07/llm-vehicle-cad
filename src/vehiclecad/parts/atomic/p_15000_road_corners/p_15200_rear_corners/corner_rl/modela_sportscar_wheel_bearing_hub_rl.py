"""Atomic part owner: PRT_ModelA_SportsCar_Wheel_Bearing_Hub_RL.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_15000_road_corners.p_15200_rear_corners.corner_rl.modela_sportscar_wheel_bearing_hub_rl",
    source_group="corner_rl",
    part_name="PRT_ModelA_SportsCar_Wheel_Bearing_Hub_RL",
    part_index=0,
