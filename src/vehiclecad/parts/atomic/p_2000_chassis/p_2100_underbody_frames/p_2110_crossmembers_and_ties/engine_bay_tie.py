"""Atomic part owner: PRT_Engine_Bay_Tie.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_2000_chassis.p_2100_underbody_frames.p_2110_crossmembers_and_ties.engine_bay_tie",
    source_group="chassis_crossmembers",
    part_name="PRT_Engine_Bay_Tie",
    part_index=0,
