"""Atomic part owner: PRT_Front_Crossmember.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_2000_chassis.p_2100_underbody_frames.p_2110_crossmembers_and_ties.front_crossmember",
    source_group="chassis_crossmembers",
    part_name="PRT_Front_Crossmember",
    part_index=0,
