"""Atomic part owner: PRT_Frame_Rail_R.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_2000_chassis.p_2100_underbody_frames.p_2110_crossmembers_and_ties.frame_rail_r",
    source_group="chassis_crossmembers",
    part_name="PRT_Frame_Rail_R",
    part_index=0,
