"""Atomic part owner: PRT_Steering_Rack_Bar_Pinion_Gear.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_4000_steering.p_4100_steering_gear.p_4110_rack_and_tie_rods.steering_rack_bar_pinion_gear",
    source_group="steering_rack",
    part_name="PRT_Steering_Rack_Bar_Pinion_Gear",
    part_index=0,
