"""Atomic part owner: PRT_ModelA_SportsCar_MTech1_Steering_Wheel_Hub.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_4000_steering.p_4200_steering_controls.p_4220_steering_wheel.modela_sportscar_mtech1_steering_wheel_hub",
    source_group="steering_wheel",
    part_name="PRT_ModelA_SportsCar_MTech1_Steering_Wheel_Hub",
    part_index=0,
