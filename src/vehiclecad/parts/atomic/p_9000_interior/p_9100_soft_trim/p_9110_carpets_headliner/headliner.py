"""Atomic part owner: PRT_Headliner.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_9000_interior.p_9100_soft_trim.p_9110_carpets_headliner.headliner",
    source_group="interior_soft_trim",
    part_name="PRT_Headliner",
    part_index=0,
