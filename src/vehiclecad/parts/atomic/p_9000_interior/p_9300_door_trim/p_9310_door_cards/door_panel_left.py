"""Atomic part owner: PRT_Door_Panel_Left.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_9000_interior.p_9300_door_trim.p_9310_door_cards.door_panel_left",
    source_group="interior_door_panels",
    part_name="PRT_Door_Panel_Left",
    part_index=0,
