"""Atomic part owner: PRT_ModelA_SportsCar_Dashboard_Shell.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_9000_interior.p_9200_cockpit_furniture.p_9220_dashboard_instruments.modela_sportscar_dashboard_shell",
    source_group="interior_dashboard",
    part_name="PRT_ModelA_SportsCar_Dashboard_Shell",
    part_index=0,
