"""Atomic part owner: PRT_ModelA_SportsCar_Centre_Vents.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_9000_interior.p_9200_cockpit_furniture.p_9220_dashboard_instruments.modela_sportscar_centre_vents",
    source_group="interior_dashboard",
    part_name="PRT_ModelA_SportsCar_Centre_Vents",
    part_index=0,
