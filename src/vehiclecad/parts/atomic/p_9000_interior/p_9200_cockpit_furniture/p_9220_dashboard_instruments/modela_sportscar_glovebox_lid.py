"""Atomic part owner: PRT_ModelA_SportsCar_Glovebox_Lid.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_9000_interior.p_9200_cockpit_furniture.p_9220_dashboard_instruments.modela_sportscar_glovebox_lid",
    source_group="interior_dashboard",
    part_name="PRT_ModelA_SportsCar_Glovebox_Lid",
    part_index=0,
