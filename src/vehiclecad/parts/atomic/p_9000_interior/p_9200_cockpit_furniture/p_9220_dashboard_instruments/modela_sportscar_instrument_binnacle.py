"""Atomic part owner: PRT_ModelA_SportsCar_Instrument_Binnacle.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_9000_interior.p_9200_cockpit_furniture.p_9220_dashboard_instruments.modela_sportscar_instrument_binnacle",
    source_group="interior_dashboard",
    part_name="PRT_ModelA_SportsCar_Instrument_Binnacle",
    part_index=0,
