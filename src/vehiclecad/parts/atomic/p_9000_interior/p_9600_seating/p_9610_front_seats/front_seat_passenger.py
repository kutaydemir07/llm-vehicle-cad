"""Atomic part owner: PRT_Front_Seat_Passenger.
...
SPEC = AtomicPartSpec(
    module_path="vehiclecad.parts.atomic.p_9000_interior.p_9600_seating.p_9610_front_seats.front_seat_passenger",
    source_group="interior_front_seats",
    part_name="PRT_Front_Seat_Passenger",
    part_index=0,
